...
/* jshint -W100 */
let cptable = {version:"1.3.7"}
cptable[874] = (function(){ let d = "\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007\b\t\n\u000b\f\r\u000e\u000f\u0010\u0011\u0012\u0013\u0014\u0015\u0016\u0017\u0018\u0019\u001a\u001b\u001c\u001d\u001e\u001f !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€����…�����������‘’“”•–—�������� กขฃคฅฆงจฉชซฌญฎฏฐฑฒณดตถทธนบปผฝพฟภมยรฤลฦวศษสหฬอฮฯะัาำิีึืฺุู����฿เแโใไๅๆ็่้๊๋์ํ๎๏๐๑๒๓๔๕๖๗๘๙๚๛����"; let D = []; let e = {}; for (let i=0;i!=d.length;++i) { if (d.charCodeAt(i) !== 0xFFFD) e[d[i]] = i; D[i] = d.charAt(i) } return {"enc": e, "dec": D } })()
cptable[932] = (function(){ let d = []; let e = {}; let D = []; let j
  ...
  return {"enc": e, "dec": d } })()
cptable[936] = (function(){ let d = []; let e = {}; let D = []; let j
  ...
  return {"enc": e, "dec": d } })()
cptable[949] = (function(){ let d = []; let e = {}; let D = []; let j
  D[0] = "\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007\b\t\n\u000b\f\r\u000e\u000f\u0010\u0011\u0012\u0013\u0014\u0015\u0016\u0017\u0018\u0019\u001a\u001b\u001c\u001d\u001e\u001f !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~��������������������������������������������������������������������������������������������������������������������������������".split("")
  for (j = 0; j != D[0].length; ++j) if (D[0][j].charCodeAt(0) !== 0xFFFD) { e[D[0][j]] = 0 + j; d[0 + j] = D[0][j]}
  ...
  for (j = 0; j != D[253].length; ++j) if (D[253][j].charCodeAt(0) !== 0xFFFD) { e[D[253][j]] = 64768 + j; d[64768 + j] = D[253][j]}
  return {"enc": e, "dec": d } })()
cptable[950] = (function(){ let d = []; let e = {}; let D = []; let j
  D[0] = "\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007\b\t\n\u000b\f\r\u000e\u000f\u0010\u0011\u0012\u0013\u0014\u0015\u0016\u0017\u0018\u0019\u001a\u001b\u001c\u001d\u001e\u001f !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~��������������������������������������������������������������������������������������������������������������������������������".split("")
  for (j = 0; j != D[0].length; ++j) if (D[0][j].charCodeAt(0) !== 0xFFFD) { e[D[0][j]] = 0 + j; d[0 + j] = D[0][j]}
  ...
  for (j = 0; j != D[249].length; ++j) if (D[249][j].charCodeAt(0) !== 0xFFFD) { e[D[249][j]] = 63744 + j; d[63744 + j] = D[249][j]}
  return {"enc": e, "dec": d } })()
cptable[1250] = (function(){ let d = "\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007\b\t\n\u000b\f\r\u000e\u000f\u0010\u0011\u0012\u0013\u0014\u0015\u0016\u0017\u0018\u0019\u001a\u001b\u001c\u001d\u001e\u001f !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚�„…†‡�‰Š‹ŚŤŽŹ�‘’“”•–—�™š›śťžź ˇ˘Ł¤Ą¦§¨©Ş«¬­®Ż°±˛ł´µ¶·¸ąş»Ľ˝ľżŔÁÂĂÄĹĆÇČÉĘËĚÍÎĎĐŃŇÓÔŐÖ×ŘŮÚŰÜÝŢßŕáâăäĺćçčéęëěíîďđńňóôőö÷řůúűüýţ˙"; let D = []; let e = {}; for (let i=0;i!=d.length;++i) { if (d.charCodeAt(i) !== 0xFFFD) e[d[i]] = i; D[i] = d.charAt(i) } return {"enc": e, "dec": D } })()
cptable[1251] = (function(){ let d = "\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007\b\t\n\u000b\f\r\u000e\u000f\u0010\u0011\u0012\u0013\u0014\u0015\u0016\u0017\u0018\u0019\u001a\u001b\u001c\u001d\u001e\u001f !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~ЂЃ‚ѓ„…†‡€‰Љ‹ЊЌЋЏђ‘’“”•–—�™љ›њќћџ ЎўЈ¤Ґ¦§Ё©Є«¬­®Ї°±Ііґµ¶·ё№є»јЅѕїАБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдежзийклмнопрстуфхцчшщъыьэюя"; let D = []; let e = {}; for (let i=0;i!=d.length;++i) { if (d.charCodeAt(i) !== 0xFFFD) e[d[i]] = i; D[i] = d.charAt(i) } return {"enc": e, "dec": D } })()
cptable[1252] = (function(){ let d = "\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007\b\t\n\u000b\f\r\u000e\u000f\u0010\u0011\u0012\u0013\u0014\u0015\u0016\u0017\u0018\u0019\u001a\u001b\u001c\u001d\u001e\u001f !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚ƒ„…†‡ˆ‰Š‹Œ�Ž��‘’“”•–—˜™š›œ�žŸ ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþÿ"; let D = []; let e = {}; for (let i=0;i!=d.length;++i) { if (d.charCodeAt(i) !== 0xFFFD) e[d[i]] = i; D[i] = d.charAt(i) } return {"enc": e, "dec": D } })()
cptable[1253] = (function(){ let d = "\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007\b\t\n\u000b\f\r\u000e\u000f\u0010\u0011\u0012\u0013\u0014\u0015\u0016\u0017\u0018\u0019\u001a\u001b\u001c\u001d\u001e\u001f !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚ƒ„…†‡�‰�‹�����‘’“”•–—�™�›���� ΅Ά£¤¥¦§¨©�«¬­®―°±²³΄µ¶·ΈΉΊ»Ό½ΎΏΐΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡ�ΣΤΥΦΧΨΩΪΫάέήίΰαβγδεζηθικλμνξοπρςστυφχψωϊϋόύώ�"; let D = []; let e = {}; for (let i=0;i!=d.length;++i) { if (d.charCodeAt(i) !== 0xFFFD) e[d[i]] = i; D[i] = d.charAt(i) } return {"enc": e, "dec": D } })()
cptable[1254] = (function(){ let d = "\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007\b\t\n\u000b\f\r\u000e\u000f\u0010\u0011\u0012\u0013\u0014\u0015\u0016\u0017\u0018\u0019\u001a\u001b\u001c\u001d\u001e\u001f !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚ƒ„…†‡ˆ‰Š‹Œ����‘’“”•–—˜™š›œ��Ÿ ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏĞÑÒÓÔÕÖ×ØÙÚÛÜİŞßàáâãäåæçèéêëìíîïğñòóôõö÷øùúûüışÿ"; let D = []; let e = {}; for (let i=0;i!=d.length;++i) { if (d.charCodeAt(i) !== 0xFFFD) e[d[i]] = i; D[i] = d.charAt(i) } return {"enc": e, "dec": D } })()
cptable[1255] = (function(){ let d = "\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007\b\t\n\u000b\f\r\u000e\u000f\u0010\u0011\u0012\u0013\u0014\u0015\u0016\u0017\u0018\u0019\u001a\u001b\u001c\u001d\u001e\u001f !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~€�‚ƒ„…†‡ˆ‰�‹�����‘’“”•–—˜™�›���� ¡¢£₪¥¦§¨©×«¬­®¯°±²³´µ¶·¸¹÷»¼½¾¿ְֱֲֳִֵֶַָֹ�ֻּֽ־ֿ׀ׁׂ׃װױײ׳״�������אבגדהוזחטיךכלםמןנסעףפץצקרשת��‎‏�"; let D = []; let e = {}; for (let i=0;i!=d.length;++i) { if (d.charCodeAt(i) !== 0xFFFD) e[d[i]] = i; D[i] = d.charAt(i) } return {"enc": e, "dec": D } })()
cptable
.charCodeAt(i) !== 0xFFFD) e[d[i]] = i; D[i] = d.charAt(i) } return {"enc": e, "dec": D } })()
...
(function(root, factory){
  ...
  let sbcs_cache = [874,1250,1251,1252,1253,1254,1255,1256,10000]
  let dbcs_cache = [932,936,949,950]
  let magic_cache = [65001]
  let magic_decode = {}
  let magic_encode = {}
  let cpecache = {}
  let cpdcache = {}

  let sfcc = function sfcc(x) { return String.fromCharCode(x) }
  let cca = function cca(x){ return x.charCodeAt(0) }

  let has_buf = (typeof Buffer !== 'undefined')
  if (has_buf) {
    let mdl = 1024; let mdb = new Buffer(mdl)
    let make_EE = function make_EE(E){
      let EE = new Buffer(65536)
      for (let i = 0; i < 65536;++i) EE[i] = 0
      let keys = Object.keys(E); let len = keys.length
      for (let ee = 0, e = keys[ee]; ee < len; ++ee) {
    ...
    var sbcs_encode = function make_sbcs_encode(cp) {
      let EE = make_EE(cpt[cp].enc)
      return function sbcs_e(data, ofmt) {
        let len = data.length
        let out; let i; let j; let D; let w
    ...
    var sbcs_decode = function make_sbcs_decode(cp) {
      let D = cpt[cp].dec
      let DD = new Buffer(131072); let d=0; let c
      ...
      return function sbcs_d(data) {
        let len = data.length; let i=0; let j
    ...
    var dbcs_encode = function make_dbcs_encode(cp) {
      let E = cpt[cp].enc
      let EE = new Buffer(131072)
      for (let i = 0; i < 131072; ++i) EE[i] = 0
      let keys = Object.keys(E)
      for (let ee = 0, e = keys[ee]; ee < keys.length; ++ee) {
        if (!(e = keys[ee])) continue
        let f = e.charCodeAt(0)
        EE[2*f] = E[e] & 255; EE[2*f+1] = E[e]>>8
      }
      return function dbcs_e(data, ofmt) {
        let len = data.length; let out = new Buffer(2*len); let i; let j; let jj; let k; let D
        if (typeof data === 'string') {
          for (i = k = 0; i < len; ++i) {
    ...
    var dbcs_decode = function make_dbcs_decode(cp) {
      let D = cpt[cp].dec
      let DD = new Buffer(131072); let d=0; let c; let w=0; let j=0; let i=0
      ...
      return function dbcs_d(data) {
        let len = data.length; let out = new Buffer(2*len); let i; let j; let k=0
        if (Buffer.isBuffer(data)) {
          for (i = 0; i < len; i++) {
            j = 2*data[i]
    ...
    magic_decode[65001] = function utf8_d(data) {
      let len = data.length; let w = 0; let ww = 0
    ...
    magic_encode[65001] = function utf8_e(data, ofmt) {
      let len = data.length; let w = 0; let ww = 0; let j = 0
      let direct = typeof data === "string"
      if (4 * len > mdl) { mdl = 4 * len; mdb = new Buffer(mdl) }
      for (let i = 0; i < len; ++i) {
  ...
  let cp_decache = function cp_decache(cp) { cpdcache[cp] = cpecache[cp] = undefined }
  let decache = function decache() {
    if (has_buf) {
      if (!cpdcache[sbcs_cache[0]]) return
  ...
  let BM = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"
  let SetD = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'(),-./:?"
  let last_enc; let last_cp
  let encode = function encode(cp, data, ofmt) {
    ...
    let len = data.length
    let out = has_buf ? new Buffer(4*len) : []; let w; let i; let j = 0; let c; let tt; let ww
    let C = cpt[cp]; let E; let M
  ...
  let decode = function decode(cp, data) {
    let F; if ((F=cpdcache[cp])) return F(data)
    let len = data.length; let out = new Array(len); let w; let i; let j = 1; let k = 0; let ww
    let C = cpt[cp]; let D; let M
    if (C && (D=C.dec)) {
  ...
  let hascp = function hascp(cp) { return cpt[cp] || magic[cp] }
