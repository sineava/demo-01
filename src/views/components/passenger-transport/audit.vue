  ...
  >
    ...
    >
      <el-descriptions-item>
        ...
        <span v-else>
          <span v-if="audit.isStatus===3">审核通过</span>
          <span v-else-if="audit.isStatus===2">审核退回</span>
      ...
      <el-descriptions-item :span="3">
        <template slot="label">审核编号:</template>
        {{ audit.reviewedCode || '-' }}
      </el-descriptions-item>
      <el-descriptions-item :span="3">
  ...
  methods: {
    ...
    initIicense(data){
      this.audit = {
        ...
        reviewedCode:data?.reviewedCode,
        reviewedFile:''
      }
      ...
      if (this.isHy){
        ...
        this.audit.reviewedCode = this.audit.reviewedCode || `TH${Date.now()}`
      }
    },
    /**
     * 保存
