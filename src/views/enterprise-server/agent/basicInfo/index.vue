      ...
      >
        ...
        >
          <el-descriptions-item label="企业名称:" :span="2">
            <template slot="label"><span v-if="isEdit" style="margin-right: 2px; color: red;">*</span>企业名称: </template>
            {{ info.enterpriseName }}
          ...
          <el-descriptions-item>
            <template slot="label"><span v-if="isEdit" style="margin-right: 2px; color: red;">*</span>企业类型:</template>
            <el-form-item v-if="isEdit" prop="agentType">
              <el-select
          ...
          <el-descriptions-item>
            <template slot="label"><span v-if="isEdit" style="margin-right: 2px; color: red;">*</span>联系人姓名:</template>
          ...
          <el-descriptions-item>
            <template slot="label"><span v-if="isEdit" style="margin-right: 2px; color: red;">*</span>联系人电话:</template>
...
<script>
import { getEnWaterAgentInfo,updateBasicInfo } from '@/api/general-services/enterpriseInfo/enterpriseInfo'
import { telephone,fax,email } from '@/utils/validate'
...
export default {
  ...
  async mounted() {
    const res = await getEnWaterAgentInfo()
    this.info = res.data
