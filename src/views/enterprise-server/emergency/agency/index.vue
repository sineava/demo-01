    ...
    <div class="app-container">
      ...
      >
        ...
        <el-table-column
          label="操作"
          align="center"
          :width="95 + (button_roles.desc ? 95 : 0) + (button_roles.update ? 95 : 0) + (button_roles.delete ? 95 : 0)"
        >
          <template v-slot="scope">
            <el-button
              size="mini"
...
export default {
  ...
  methods: {
    ...
    handleEdit(type, item) {
      this.$router.push({ path: '/emergency/agencyEdit', query: { id: item ? item.id : null, type }})
    },
    /**
     * 删除
     */
