  ...
  <el-card class="body-card">
    ...
    <div class="app-container">
      ...
      >
        ...
        <el-table-column
          label="操作"
          :width="Object.keys(button_roles).length * 80 + 80"
        >
          <template v-slot="scope">
            <el-button
              size="mini"
...
export default {
  ...
  methods: {
    ...
    handleEdit(type, item) {
      this.$router.push({ path: '/emergency/reserveEdit', query: { id: item ? item.id : null, type }})
    },
    /**
     * 应急物资(跳转到应急物资,携带储备点id)
     */
    handleResource(_, item) {
      this.$router.push({ path: '/emergency/info', query: { id: item.id,name:item.name }})
    },
    /**
     * 删除
     */
