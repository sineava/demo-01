      ...
      >
        ...
        >
          ...
          <el-descriptions-item :span="3">
            ...
            <span
              v-if="oper==='add' || oper==='edit' || oper==='change'"
              style="display: inline-block; float: left; margin: 0 10px 0 0; height: 200px;"
            >
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        actualStartTime: [
          { required: true, message: '请选择开始演练时间', trigger: 'blur' }
        ],
        actualEndTime: [
          { required: true, message: '请选择结束演练时间', trigger: 'blur' }
        ],
        actualDays: [
