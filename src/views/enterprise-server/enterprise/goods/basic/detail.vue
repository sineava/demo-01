  ...
  <el-card class="body-card">
    ...
    <div v-show="tabIndex===1" class="basic-detail">
      ...
      >
        ...
        <el-descriptions-item label="计划开工年月:">{{ ruleForm.planStartDate }}</el-descriptions-item>
        <el-descriptions-item label="计划完工年月:">{{ ruleForm.planEndDate }}</el-descriptions-item>
        <el-descriptions-item label="实际开工年月:">{{ ruleForm.actualStartDate }}</el-descriptions-item>
        <el-descriptions-item label="实际完工年月:">{{ ruleForm.actualEndDate }}</el-descriptions-item>
...
export default {
  ...
  methods: {
    ...
    // 返回
    returnBack() {
      this.$router.push({ path: '/enterprise/goods/basic' })
    },
  }
}
</script>
