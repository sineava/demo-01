  ...
  <el-card class="body-card">
    ...
    <div>
      ...
      >
        ...
        <el-table-column label="收费标准名称" :show-overflow-tooltip="true" prop="tableName" />
        <el-table-column label="更新人" :show-overflow-tooltip="true" prop="updateBy" />
        <el-table-column label="更新时间" :show-overflow-tooltip="true" prop="updateTime" />
        <el-table-column
...
export default {
  ...
  methods: {
     ...
     */
    handleDetail(item) {
      this.$router.push({ path: '/enterprisecharge/freightbasisDetail', query: { tableName: item.tableType }})
    }
  }
}
</script>
