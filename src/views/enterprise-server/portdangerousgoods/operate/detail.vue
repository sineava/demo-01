  ...
  <el-card class="body-card">
    ...
    >
      ...
      <span class="detail-header-button">
        <el-button :type="tabIndex===1?'primary':''" size="medium" @click="tabIndex=1">港口危险货物作业情况反馈</el-button>
        <el-button :type="tabIndex===2?'primary':''" size="medium" @click="tabIndex=2">港口危险货物作业申报信息</el-button>
        <el-button :type="tabIndex===3?'primary':''" size="medium" @click="tabIndex=3">港口危险货物作业业务信息</el-button>
        <el-button :type="tabIndex===4?'primary':''" size="medium" @click="tabIndex=4">港口危险货物作业审批信息</el-button>
      </span>
    </div>
    <div class="basic-detail3">
      ...
      <template v-if="tabIndex === 4">
        ...
        >
          ...
          <el-descriptions-item label="船舶/车辆国籍:">{{ ruleForm && ruleForm.boatNationality }}</el-descriptions-item>
