  ...
  <el-card class="body-card">
    ...
    <div class="app-container">
      ...
      >
        ...
        >
          <el-input
            v-model.trim="searchForm.approvalUnit"
            placeholder="请输入审批单位"
          />
        </el-form-item>
        <el-form-item
      ...
      >
        ...
        <el-table-column label="企业类别名称">
          <template v-slot="scope">
            {{ scope.row.enterpriseCategoryName }}
          </template>
        </el-table-column>
        <el-table-column label="危险货物作业单位">
          <template v-slot="scope">
            {{ scope.row.operationUnit }}
          </template>
        </el-table-column>
        <el-table-column label="审批单位">
          <template v-slot="scope">
            {{ scope.row.approvalUnit }}
          </template>
        </el-table-column>
        <el-table-column label="审批结果">
          <template v-slot="scope">
            {{ scope.row.approvalResult || '未通过' }}
          </template>
        </el-table-column>
        <el-table-column
          label="操作"
