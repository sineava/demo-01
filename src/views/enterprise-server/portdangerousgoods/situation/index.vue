  ...
  <el-card class="body-card">
    ...
    <div class="app-container">
      ...
      >
        ...
        <el-table-column label="所在地市港口管理部门">
          <template v-slot="scope">
...
<script>
import { getEnList } from '@/api/port-services/danger-goods/stock-equipment'
...
export default {
  ...
  methods: {
    ...
    // 存储记录
    handleRecord(item) {
      this.$router.push({ path: '/portdangerousgoods/situationRecord', query: { stockEquipmentId: item ? item.id : null, company:item.company }})
    },
    // 详情/编辑/新增
