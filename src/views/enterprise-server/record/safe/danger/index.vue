  ...
  <el-card class="body-card">
    ...
    <div class="app-container">
      ...
      >
        ...
        >
          <el-input
            v-model.trim="searchForm.warehouseAreaName"
            placeholder="请输入企业名称"
          />
        </el-form-item> -->
        <el-form-item
...
import { pageEnList } from '@/api/port-services/record-management/major-hazard-filing'
...
export default {
  ...
  methods: {
    ...
    handleDetail(row, isEdit) {
      ...
      this.$router.push({ path: `/record/safe/dangerDetail?isEdit=${isEdit}&isAcceptance=${isAcceptance}&id=${row.id}` })
    },
    /**
     * 添加
     */
    add() {
      this.$router.push({ path: `/record/safe/addDanger` })
    }
  }
}
</script>
