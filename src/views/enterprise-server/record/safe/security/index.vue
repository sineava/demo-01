...
import { pageEnList } from '@/api/port-services/record-management/report-filing'
...
export default {
  ...
  methods: {
    ...
    handleDetail(row, isEdit) {
      ...
      this.$router.push({ path: `/record/safe/securityDetail?isEdit=${isEdit}&isAcceptance=${isAcceptance}&id=${row.id}` })
    },
    /**
     * 添加
     */
