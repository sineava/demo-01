...
import { pageEnSmPersonFilingList } from '@/api/water-transportation-services/keep-on-record/ship-manage-person-filing'
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      pageEnSmPersonFilingList(data).then(res => {
     ...
     */
    handleDetail(item) {
      this.$router.push({ path: '/record/water/ship/personnelInfoDetail', query: { id: item.id }})
    }
  }
}
</script>
