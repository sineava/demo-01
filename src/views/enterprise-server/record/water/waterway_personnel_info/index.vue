...
import { pageEnWtmPersonFilingList } from '@/api/water-transportation-services/keep-on-record/wt-manage-person-filing'
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      pageEnWtmPersonFilingList(data).then(res => {
     ...
     * 详情
     */
    handleDetail(oper,item) {
      this.$router.push({ path: '/record/water/waterway/personnelInfoDetail', query: { id: item.id,oper:oper }})
    }
  }
}
</script>
