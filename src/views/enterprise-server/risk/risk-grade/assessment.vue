...
export default {
  ...
  computed: {
    happenPossibilityPopover() {
      return [
        { level: '极高', val: '极易', section: '9＜取值≤10' },
        { level: '高', val: '易', section: '6＜取值≤9' },
        { level: '中等', val: '可能', section: '3＜取值≤6' },
        { level: '低', val: '不大可能', section: '1＜取值≤3' },
        { level: '极低', val: '极不可能', section: '0＜取值≤1' }
      ]
    },
    seriousDegreePopover() {
      return [
        { name: '特别严重（10）', desc: '（1）人员伤亡：可能发生人员伤亡数量达到《生产安全事故报告和调查处理条例》中特别重大事故伤亡标准，或达到《水路交通突发事件应急预案》中突发事件I级伤亡标准的；（2）经济损失：可能发生经济损失达到《生产安全事故报告和调查处理条例》中特别重大事故经济损失标准，或达到《水路交通突发事件应急预案》中突发事件I级损失标准的；（3）环境污染：可能造成特别重大生态环境灾害或公共卫生事件，或达到《国家突发环境事件应急预案》中特别重大突发环境事件标准的；（4）社会影响：可能对国家或区域的社会、经济、外交、军事、政治等产生特别重大影响。' },
        { name: '严重（5）', desc: '（1）人员伤亡：可能发生人员伤亡数量达到《生产安全事故报告和调查处理条例》中重大事故伤亡标准，或达到《水路交通突发事件应急预案》中突发事件II级伤亡标准的；（2）经济损失：可能发生经济损失达到《生产安全事故报告和调查处理条例》中重大事故经济损失标准，或达到《水路交通突发事件应急预案》中突发事件II级损失标准的；（3）环境污染：可能造成重大生态环境灾害或公共卫生事件，或达到《国家突发环境事件应急预案》中重大突发环境事件标准的；（4）社会影响：可能对国家或区域的社会、经济、外交、军事、政治等产生重大影响。' },
        { name: '较严重（2）', desc: '（1）人员伤亡：可能发生人员伤亡数量达到《生产安全事故报告和调查处理条例》中较大事故伤亡标准，或达到《水路交通突发事件应急预案》中突发事件III级伤亡标准的；（2）经济损失：可能发生经济损失达到《生产安全事故报告和调查处理条例》中较大事故经济损失标准，或达到《水路交通突发事件应急预案》中突发事件III级损失标准的；（3）环境污染：可能造成较大生态环境灾害或公共卫生事件，或达到《国家突发环境事件应急预案》中较大突发环境事件标准的；（4）社会影响：可能对国家或区域的社会、经济、外交、军事、政治等产生较大影响。' },
        { name: '不严重（1）', desc: '（1）人员伤亡：可能发生人员伤亡数量达到《生产安全事故报告和调查处理条例》中一般事故伤亡标准，或达到《水路交通突发事件应急预案》中突发事件IV级伤亡标准的；（2）经济损失：可能发生经济损失达到《生产安全事故报告和调查处理条例》中一般事故经济损失标准，或达到《水路交通突发事件应急预案》中突发事件IV级损失标准的；（3）环境污染：可能造成一般生态环境灾害或公共卫生事件，或达到《国家突发环境事件应急预案》中一般突发环境事件标准的；（4）社会影响：可能对国家或区域的社会、经济、外交、军事、政治等产生较小影响。' }
      ]
    }
  },
  async mounted() {
