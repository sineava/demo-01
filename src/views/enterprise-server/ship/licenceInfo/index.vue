...
import { pageEnList,deleteLicense } from '@/api/water-transportation-services/information/ship-manage-business-license'
...
export default {
  ...
  methods: {
    ...
    handleDetail(type,item) {
      if (type==='detail'){
        this.$router.push({ path: '/ship/licenceInfoDetail', query: { id: item.id }})
      } else {
        this.$router.push({ path: '/ship/licenceInfoEdit', query: { id: item.id }})
      }
    }
  }
}
