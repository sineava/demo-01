...
import { pageShipEnShipList,unbound } from '@/api/water-transportation-services/information/enterprise-ship'
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      pageShipEnShipList(data).then(res => {
    ...
    handleDetail(type,item) {
      switch (type) {
      case 'add':
        this.$router.push({ path: '/ship/managementInfoDetail', query: { id: '',type:3,oper:type }})
        break
      case 'edit':
        this.$router.push({ path: '/ship/managementInfoDetail', query: { id: item.id,type:3,oper:type }})
        break
      case 'info':
        this.$router.push({ path: '/ship/managementInfoDetail', query: { id: item.id,type:3,oper:type }})
        break
