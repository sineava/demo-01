...
import { pageShipEnList,deletePersonnel } from '@/api/water-transportation-services/information/manage-person'
...
export default {
  ...
  methods: {
    ...
    handleDetail(type,item) {
      if (type==='detail'){
        this.$router.push({ path: '/ship/personnelInfoDetail', query: { id: item.id,oper:type }})
      } else {
        this.$router.push({ path: '/ship/personnelInfoEdit', query: { id: item.id,oper:type }})
      }
    }
  }
}
