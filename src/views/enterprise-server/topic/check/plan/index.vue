          ...
          <el-row :gutter="10">
            <el-col :span="12">
              <el-card class="card-m">
                ...
                <Charts :option="coverOpt" style="height: 340px;" />
              </el-card>
            </el-col>
            <el-col :span="12">
              <el-card class="card-m">
                ...
                <Charts :option="typeOpt" style="height: 340px;" />
              </el-card>
            </el-col>
          </el-row>
        </el-col>
...
import { Ring } from '@/utils/charts-basic-options'
  ...
  methods: {
    ...
    topic(queryData){
      ...
      getTopicStat(this.queryData).then(res=>{
        const {count, enterpriseCount=0, enterpriseInCount=0, typeStatisticalList = []} = res.data || {}
        this.count = count
