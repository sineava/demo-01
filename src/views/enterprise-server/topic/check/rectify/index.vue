          ...
          <el-row :gutter="10">
            <el-col :span="12">
              <el-card class="card-m">
                ...
                <Charts :option="issueOpt" style="height: 340px" />
              </el-card>
            </el-col>
            <el-col :span="12">
              <el-card class="card-m">
                ...
                <Charts :option="checkOpt" style="height: 340px" />
              </el-card>
            </el-col>
          </el-row>
        </el-col>
...
import {
  ...
  exportTopicList,
  getTopicStat
} from "@/api/general-services/topic/safety-improvement-record-statistical"
