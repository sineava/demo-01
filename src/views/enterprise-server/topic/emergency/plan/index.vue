  ...
  data() {
    return {
      ...
      searchData:[
        ...
        {label:'发布时间',prop:['screenStartTime','screenEndTime'],form:'daterange',condition:'eq',data:'',type:'daterange',format:['yyyy-MM-dd 00:00:00','yyyy-MM-dd 23:59:59']},
    ...
    topicAeg(queryData){
      ...
      getTopicPlan(this.queryData).then(res=>{
        if (res.code === "0") {
          ...
          this.levelOpt = new Pie(levelOptSeriesArr).option
          ...
          this.typeOpt = new Pie(typeOptSeriesArr).option
