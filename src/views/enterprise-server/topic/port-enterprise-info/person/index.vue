      ...
      <el-row :gutter="20">
        ...
        <el-col :span="18">
          <el-row :gutter="10">
            ...
            <el-col :span="12">
              <el-card class="topic-card">
                部门数量：<span>{{ info.enterpriseCount }}</span>
              </el-card>
            </el-col>
          </el-row>
          <el-row :gutter="10">
  ...
  data() {
    return {
      ...
      options:[
        ...
        {label:'人员类型',isShow:true,prop:'personType',type:'only-num',
          payload:[
            {value:1,label:'一般人员'},
        ...
        {label:'所属部门',type:'text',isShow:true,prop:'organizationName'},
    ...
    topic(queryData){
      ...
      getTopicStat(this.queryData).then(res=>{
        if (res.code === "0") {
          ...
          this.deptOpt = new Bar(eName, eValue,{top: '30',left: '20',right: '45',bottom: '10',containLabel: true},eName.length>10 ? 90 : 0,'数量','部门').option
        }
      })
    },
