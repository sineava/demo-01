    ...
    <div class="water-detail">
      ...
      >
        <div class="icon-title">
          ...
          <span class="oper-button" style="position: absolute; right: 32px;">
            <el-button
              v-if="isEdit"
              type="primary"
              size="mini"
...
<script>
import { getEnWaterTransportInfo,updateBasicInfo } from '@/api/general-services/enterpriseInfo/enterpriseInfo'
...
export default {
  ...
  methods: {
    ...
    async init(){
      const res = await getEnWaterTransportInfo()
      this.info = res.data
