  ...
  <el-card class="body-card">
    ...
    <div class="app-container">
      ...
      >
        ...
        <el-table-column label="上报从业人员数量" :show-overflow-tooltip="true" prop="count" />
...
<script>
import { getRecordList } from '@/api/credit/employees/data-summary'
...
export default {
  ...
  methods: {
    ...
    handleInfo(type, item) {
      this.$router.push({ path: '/credit/employees/data-summary/details', query: { type, basicId: item ? item.id : null }})
    }
  }
}
</script>
