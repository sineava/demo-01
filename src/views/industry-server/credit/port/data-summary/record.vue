  ...
  <el-card class="body-card">
    ...
    <div class="app-container">
      ...
      >
        ...
        <el-table-column label="上报港口企业数量" :show-overflow-tooltip="true" prop="count" />
...
<script>
import { getRecordList } from '@/api/credit/port/data-summary'
...
export default {
  ...
  methods: {
    ...
    handleInfo(type, item) {
      this.$router.push({ path: '/credit/port/data-summary/details', query: { type, basicId: item ? item.id : null }})
    }
  }
}
</script>
