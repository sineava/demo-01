  ...
  <div>
    ...
    >
      <el-form-item
        ...
        prop="name"
      >
        <el-input v-model.trim="ruleForm.name" maxlength="100" placeholder="请输入机构名称" />
      </el-form-item>
      <el-form-item
        label="概述:"
        class="top-form-item"
...
<script>
import { getInfo, addData, updateData } from '@/api/data-management/overall-distribution/organization'
export default {
  data() {
    return {
      isEdit: false,
