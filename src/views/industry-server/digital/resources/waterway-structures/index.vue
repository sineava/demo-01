...
import { getList, removeData } from '@/api/data-management/resources/channel-building'
...
export default {
  ...
  methods: {
    ...
    handleDetail(item, isEdit) {
      this.$router.push({ path: '/digital/resources/waterwayStructuresDetail', query: { id: item.id, isEdit: isEdit }})
    }
  }
}
</script>
