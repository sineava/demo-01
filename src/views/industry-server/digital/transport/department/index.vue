  ...
  <el-card class="body-card">
    ...
    <div class="app-container">
      ...
      >
        ...
        <el-table-column label="区县港航部门名称">
          <template v-slot="scope">
...
<script>
import { getPageList, deleteInfo } from '@/api/channel-services/period/department'
...
export default {
  ...
  methods: {
    ...
    handleEdit(type, item) {
      this.$router.push({ path: '/digital/transport/departmentEdit', query: { type, id: item ? item.id : null }})
    },
    /**
     * 删除
     */
