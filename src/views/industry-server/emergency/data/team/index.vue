  ...
  <el-card class="body-card">
    ...
    <div class="app-container">
      ...
      >
        ...
        <!-- <el-table-column label="所属港区" :show-overflow-tooltip="true">
          <template v-slot="scope">
...
export default {
  ...
  methods: {
     ...
     */
    handleAdd(type, item) {
      this.$router.push({ path: '/emergency/data/teamAdd', query: { id: item ? item.id : null, type }})
    },
    /**
     * 详情
     */
    handleDetail(_, item) {
      this.$router.push({ path: '/emergency/data/teamDetail', query: { id: item.id }})
    },
    /**
     * 删除
     */
