  ...
  <el-card class="body-card">
    ...
    >
      <span class="detail-back">
        <el-page-header @back="returnBack" content="收费标准详情" />
      </span>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      tabledata: [],
      standard: 'port', // 港口标准
      payload: 'enterpriseDetail'
    }
  },
  created() {
    const { tableType, enterpriseId } = this.$route.query
  ...
  methods: {
    ...
    // 返回
    returnBack() {
      this.$router.push({ path: '/enterprisecharges/charge' })
    }
  }
}
</script>
