...
<script>
import { dataAnalysisList } from '@/api/general-services/enterprise-self-inspection/examineSituation'
...
export default {
  ...
  methods: {
    ...
    handleDetail(item) {
      this.$router.push({ path: '/safe/ledger/companydangerDetail', query: { id: item ? item.id : null, disabled: 1 }})
    }
  }
}
</script>
