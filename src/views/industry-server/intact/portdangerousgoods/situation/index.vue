  ...
  <el-card class="body-card">
    ...
    <div class="app-container">
      ...
      >
        ...
        >
          <el-input
            v-model.trim="searchForm.coastlineName"
            placeholder="请输入所属区域"
          />
        </el-form-item>
        <el-form-item
...
<script>
import { getInPageList } from '@/api/port-services/danger-goods/stock-equipment'
...
export default {
  ...
  methods: {
    ...
    // 存储记录
    handleRecord(item) {
      this.$router.push({ path: '/intact/portdangerousgoods/situation/record', query: { id: item ? item.id : null }})
    },
    // 详情/编辑/新增
    handleEdit(type, item) {
      this.$router.push({ path: '/intact/portdangerousgoods/situation/detail', query: { type, id: item ? item.id : null }})
    }
  }
}
</script>
