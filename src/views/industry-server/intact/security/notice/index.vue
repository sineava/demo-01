...
<script>
import { getNoticeInfo } from '@/api/general-services/safety-supervision-and-inspection/noticeInfo'
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      getNoticeInfo(queryInfo).then(res => {
    ...
    handleDetail(item) {
      this.$router.push({ path: '/safe/supervise/rectificationNoticeDetail', query: { id: item ? item.id : null }})
    }
  }
}
</script>
