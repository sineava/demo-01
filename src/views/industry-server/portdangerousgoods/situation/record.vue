...
import { getList } from '@/api/port-services/danger-goods/dangerous-goods-record'
...
export default {
  ...
  methods: {
    ...
    handleEdit(type, item) {
      this.$router.push({ path: '/portdangerousgoods/situationRecordEdit', query: { type, id: item ? item.id : null, stockEquipmentId: this.stockEquipmentId }})
    }
  }
}
</script>
