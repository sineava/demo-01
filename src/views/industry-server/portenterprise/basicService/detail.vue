  ...
  <el-card class="body-card">
    ...
    >
      <span class="detail-back">
        <el-page-header @back="returnBack" content="港口服务企业详情" />
      </span>
    </div>
...
<script>
import { getHyPortServicesInfo,updateBasicInfo } from '@/api/general-services/enterpriseInfo/enterpriseInfo'
...
export default {
  ...
  async created() {
    ...
    this.type = type
    const res = await getHyPortServicesInfo(id)
    this.info = res.data
