  ...
  <el-card class="body-card">
    ...
    <div class="app-container">
      ...
      >
        ...
        <el-table-column v-if="button_roles.desc" width="100" label="操作">
          <template v-slot="scope">
            <el-button
...
import { trainingSituatioPageList } from '@/api/general-services/educateTrain/educationSituation'
...
export default {
  ...
  methods: {
    ...
    handleDetail(type, item) {
      this.$router.push({ path: '/portenterprise/educate/trainingsituationDetail', query: { type, id: item ? item.id : null, enterpriseName: item.enterpriseName }})
    }
  }
}
</script>
