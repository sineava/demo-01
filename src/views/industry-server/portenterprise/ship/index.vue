...
import { pageShipManageEnList } from '@/api/general-services/enterpriseInfo/enterpriseInfo'
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      pageShipManageEnList(data).then(res => {
    ...
    handleDetail(item, disabled) {
      ...
      this.$router.push({ path: '/portenterprise/shipDetail', query: { id: item.id, enterpriseName: item.enterpriseName, disabled: disabled }})
    }
  }
}
</script>
