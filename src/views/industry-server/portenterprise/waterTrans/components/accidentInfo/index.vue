...
import { pageHyMajorAccidentList } from '@/api/water-transportation-services/information/water-transport-en-major-events-filing'
export default {
  components: {
    pagination
  },
  ...
  methods: {
     ...
     */
    handleDetail(item) {
      this.$router.push({ path: '/portenterprise/accidentInfoDetail', query: { id: item.id }})
    }
  }
}
</script>
