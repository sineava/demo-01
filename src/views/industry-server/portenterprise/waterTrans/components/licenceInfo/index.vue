...
import { pageHyList,deleteLicense } from '@/api/water-transportation-services/information/water-transport-business-license'
export default {
  components: {
    pagination
  },
  ...
  methods: {
    ...
    handleDetail(type,item) {
      if (type==='detail'){
        this.$router.push({ path: '/portenterprise/licenceInfoDetail', query: { id: item.id,enterpriseId:this.searchForm.enterpriseId,enterpriseName:this.enterpriseName }})
      } else {
        this.$router.push({ path: '/portenterprise/licenceInfoEdit', query: { id: item.id,enterpriseId:this.searchForm.enterpriseId,enterpriseName:this.enterpriseName }})
      }
    }
  }
}
