...
import { pageHyList } from '@/api/port-services/record-management/major-hazard-filing'
...
export default {
  ...
  methods: {
    ...
    handleDetail(row, isEdit) {
      ...
      this.$router.push({ path: `/record/safe/dangerDetail?isEdit=${isEdit}&isAcceptance=${isAcceptance}&id=${row.id}&tabActive=${this.tabActive}` })
    }
  }
}
</script>
