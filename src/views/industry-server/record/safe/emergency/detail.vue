<template>
  <el-card class="body-card">
    ...
    <div class="basic-detail">
      <Emergency ref="Emergency" :data="info" :isEdit="false" />
...
<script>
import { findById, recordAcceptance, recordReview } from '@/api/port-services/record-management/emergency-filing'
...
export default {
  ...
  methods: {
     ...
     */
    returnBack() {
      this.$router.push({ path: `/record/safe/emergency?tabActive=${this.tabActive}` })
    }
  }
}
</script>