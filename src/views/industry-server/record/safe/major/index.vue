...
import { pageHyList } from '@/api/port-services/record-management/major-threat-filing'
...
export default {
  ...
  methods: {
    ...
    handleDetail(row, isEdit) {
      ...
      this.$router.push({ path: `/record/safe/majorDetail?isEdit=${isEdit}&isAcceptance=${isAcceptance}&id=${row.id}&tabActive=${this.tabActive}` })
    }
  }
}
</script>
