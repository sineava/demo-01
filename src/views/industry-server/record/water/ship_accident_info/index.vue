...
import { pageHyMajorAccidentFilingList } from '@/api/water-transportation-services/information/ship-en-major-events-filing'
...
export default {
  ...
  methods: {
    ...
    handleDetail(item, isEdit) {
      this.$router.push({ path: '/record/water/ship/accidentInfoDetail', query: { id: item.id, isEdit: isEdit }})
    }
  }
}
</script>
