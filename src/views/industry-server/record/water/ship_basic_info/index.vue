...
import { pageHyBaseFilingList } from '@/api/water-transportation-services/keep-on-record/sm-en-base-filing'
...
export default {
  ...
  methods: {
    ...
    handleDetail(item, isEdit) {
      this.$router.push({ path: '/record/water/ship/basicInfoDetail', query: { id: item.id, isEdit }})
    }
  }
}
</script>
