  ...
  <el-card class="body-card">
    ...
    <div class="app-container">
      ...
      >
        ...
        <el-table-column label="变更后的船舶名称">
          <template v-slot="scope">
            <span
...
import { pageHyList } from '@/api/water-transportation-services/keep-on-record/ship-manage-en-ship-change-filing'
...
export default {
  ...
  methods: {
    ...
    handleDetail(item, isEdit) {
      this.$router.push({ path: '/record/water/ship/entrustShipDetail', query: { id: item.id, isEdit: isEdit }})
    }
  }
}
</script>
