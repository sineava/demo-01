...
import { pageHyMajorAccidentFilingList } from '@/api/water-transportation-services/information/water-transport-en-major-events-filing'
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      pageHyMajorAccidentFilingList(data).then(res => {
    ...
    handleDetail(item, isEdit) {
      this.$router.push({ path: '/record/water/waterway/accidentInfoDetail', query: { id: item.id, isEdit: isEdit }})
    }
  }
}
</script>
