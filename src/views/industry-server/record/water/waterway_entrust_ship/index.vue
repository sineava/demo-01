  ...
  <el-card class="body-card">
    ...
    <div class="app-container">
      ...
      >
        ...
        <el-table-column
          label="委托企业名称"
          prop="changeEnterpriseName"
        />
        <el-table-column label="备案类型">
          <template v-slot="scope">
            {{ scope.row.filingType===1?'委托船舶管理企业变更':'委托管理协议变更' }}
          </template>
        </el-table-column>
...
import { pageHyChangeFilingList } from '@/api/water-transportation-services/keep-on-record/entrust-change-filing'
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      pageHyChangeFilingList(data).then(res => {
    ...
    handleDetail(item, isEdit) {
      this.$router.push({ path: '/record/water/waterway/entrustShipDetail', query: { id: item.id, isEdit: isEdit }})
    }
  }
}
</script>
