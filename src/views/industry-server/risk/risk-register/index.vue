        ...
        <el-table-column label="制险因素" :show-overflow-tooltip="true">
          <el-table-column label="人的因数">
            <template v-slot="scope">
              <span
                ...
                :key="scope.$index+'-1-'+index+'-'+item.factorsName"
              >
          ...
          <el-table-column label="设备因素" :show-overflow-tooltip="true">
            <template v-slot="scope">
              <span
                v-for="(item,index) in scope.row.riskControlFactorsInfoVoList"
                :key="scope.$index+'-2-'+index+'-'+item.factorsName"
              >
          ...
          <el-table-column label="环境因素" :show-overflow-tooltip="true">
            <template v-slot="scope">
              <span
                v-for="(item,index) in scope.row.riskControlFactorsInfoVoList"
                :key="scope.$index+'-3-'+index+'-'+item.factorsName"
              >
          ...
          <el-table-column label="管理因素" :show-overflow-tooltip="true">
            <template v-slot="scope">
              <span
                v-for="(item,index) in scope.row.riskControlFactorsInfoVoList"
                :key="scope.$index+'-4-'+index+'-'+item.factorsName"
              >
...
import { pageHyList } from '@/api/port-services/risk-identification/major-risk-register'
