  ...
  <el-card class="body-card">
    ...
    >
      <span class="detail-back">
        <el-page-header @back="returnBack" :content="ruleForm.id ? (isDisabled ? '违规行为类别详情' : '编辑违规行为类别') : '新增违规行为类别'" />
      </span>
    </div>
    <div class="basic-detail">
      ...
      >
        <el-form-item
          ...
          prop="name"
        >
          <el-input v-model.trim="ruleForm.name" placeholder="请输入类别名称" maxlength="30" />
        </el-form-item>
        <el-form-item
          label="违规类别描述:"
          prop="explanation"
