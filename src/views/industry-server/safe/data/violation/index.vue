  ...
  <el-card class="body-card">
    ...
    <div class="app-container">
      ...
      >
        ...
        >
          <template v-slot="scope">
            {{ scope.row.explanation && scope.row.explanation.length > 20 ? scope.row.explanation.slice(0, 20) + '...' : scope.row.explanation }}
          </template>
        </el-table-column>
        <el-table-column
...
export default {
  ...
  methods: {
    ...
    handleAdd(item, disabled) {
      this.$router.push({ path: '/safe/data/violationAdd', query: { item: item, disabled: disabled }})
    },
    /**
     * 删除
     */
