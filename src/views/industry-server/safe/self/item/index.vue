    ...
    <div class="app-container">
      ...
      >
        ...
        <el-table-column label="创建机构" :show-overflow-tooltip="true">
          <template v-slot="scope">
            <span :class="scope.row.type===2 ? 'enterprise' : ''">{{ scope.row.isUseUnit }}</span>
          </template>
        </el-table-column>
        <el-table-column
          label="创建人"
...
<script>
import { pageHyList, deleteItem } from '@/api/general-services/enterprise-self-inspection/examineItem'
