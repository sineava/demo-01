  ...
  <el-card class="body-card">
    ...
    >
      <span class="detail-back">
        <el-page-header @back="returnBack" content="企业自查详情页" />
      </span>
    </div>
    <div class="info-detail detail">
      ...
      >
        <el-descriptions-item label="自查名称:">{{ruleForm.examineName}}</el-descriptions-item>
        <el-descriptions-item label="开展时间:">{{ruleForm.launchTime}}</el-descriptions-item>
        <el-descriptions-item label="自查项分类:" v-if="ruleForm.categoryId">
          {{categoryList.find(x => x.id === ruleForm.categoryId).name}}
    ...
    initEdit(id) {
      getSituation(this.ruleForm.id).then(res => {
        this.ruleForm = {
          ...
          categoryId: res.data.enterpriseId,
