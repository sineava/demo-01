    ...
    topic(queryData){
      ...
      getTopicStat(this.queryData).then(res=>{
        ...
        this.info = {
          ...
          personCount:res.data?.personCount || 0,
        ...
        this.teamOpt = new Bar(eName, eValue,{top: '30',left: '10',right: '65',bottom: '10',containLabel: true},eName.length>10 ? 90 : 0,'单位(人)','应急队伍').option
      })
    },
