          ...
          <el-row :gutter="10">
            <el-col :span="12">
              <el-card class="topic-card">
                ...
                <p style="line-height: 73px;">有效期内的证书数量：<span>{{ info.count }}</span></p>
              </el-card>
            </el-col>
            <el-col :span="12">
              <el-card class="topic-card">
    ...
    topic(queryData){
      ...
      getTopicStat(this.queryData).then(res=>{
        if (res.code === "0") {
          ...
          this.deptOpt = new Bar(eName, eValue,{top: '30',left: '20',right: '45',bottom: '10',containLabel: true},eName.length>10 ? 40 : 0,'数量','机构').option
        }
      })
    },
